...
from dataloaderv2 import get_train_augmentation, get_test_augmentation, get_loader, gt_to_tensor
...
class Trainer():
    def __init__(self, args, save_path):
        ...
        sys.stdout = Logger(os.path.join('output_dir', 'log_file_{0}.txt'.format(args.arch)))
        #sys.stdout = Logger('log_file_{0}.txt'.format(args.arch))
